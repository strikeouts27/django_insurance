...
class Customer_Form(forms.Form):
    ...
    address = forms.CharField(max_length=20, label="What is your address?", required=True)
    ...
    email = forms.EmailField(max_length= 20, required=False, label='What is your email address?')
